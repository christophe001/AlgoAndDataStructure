...
public final class StdIn {
	...
	public static int readInt() {
		try {
			...
			throw new NoSuchElementException(
					"attempts to read a 'int' value from standard input,"
					+ " but there are no more tokens available");
		}
	}
	...
	public static float readFloat() {
		try {
			...
			String token = scanner.next();
			throw new InputMismatchException(
					"attempts to read an 'float' value from standard input,"
					+ " but the next token is \"" 
					+ token + "\"");
		}
		catch(NoSuchElementException e) {
	...
	public static long readLong() {
		try {
			...
			String token = scanner.next();
			throw new InputMismatchException(
					"attempts to read an 'long' value from standard input,"
					+ " but the next token is \"" 
					+ token + "\"");
		}
		catch(NoSuchElementException e) {
	...
	public static short readShort() {
		try {
			...
			String token = scanner.next();
			throw new InputMismatchException(
					"attempts to read an 'short' value from standard input,"
					+ " but the next token is \"" 
					+ token + "\"");
		}
		catch(NoSuchElementException e) {
	...
	public static byte readByte() {
		try {
			...
			String token = scanner.next();
			throw new InputMismatchException(
					"attempts to read an 'byte' value from standard input,"
					+ " but the next token is \"" 
					+ token + "\"");
		}
		catch(NoSuchElementException e) {
	...
	public static boolean readBoolean() {
		try {
			...
			throw new InputMismatchException(
					"attempts to read an 'boolean' value from standard input,"
					+ " but the next token is \"" 
					+ token + "\"");
		}
		catch (NoSuchElementException e) {
